...
@bells_user_filter.message(F.text == "Звонки")
async def filter_bells_handler(message: Message) -> None:
    ...
    if not member_check or not privacy_check or not auth_check:
        ...
        image_from_pc = FSInputFile("source/data/image/расписание_звонков.png")
