...
@holidays_user_filter.message(F.text == "Каникулы")
async def filter_holidays_handler(message: Message) -> None:
    ...
    if not member_check or not privacy_check or not auth_check:
        ...
        image_from_pc = FSInputFile("source/data/image/расписание_каникул.png")
